...
Работаю с Git/GitLab в командной среде и инструментами Postman.  
...
### 💼 Коммерческий проект: Android приложение BRAVE

- **Админка приложения:** [https://ibrave.app/admin](https://ibrave.app/admin)  
- **Документация API:** [https://ibrave.app/doc/api](https://ibrave.app/doc/api)  
- Работал в команде из 2 разработчиков: 1 backend, 1 Android  
- Использовал GitLab, Postman, админка реализована на Craftable  
- Могу подробнее скинуть апк в лс
